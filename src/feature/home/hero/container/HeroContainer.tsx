...
const HeroContainer: React.FC<HeroContainerProps> = ({ data }) => {
  ...
  return (
    <main className=" w-full bg-gradient-to-br from-neutral-800 to-primary-600">
      <section className="h-full md:min-h-screen w-full flex flex-col mycontainer lg:flex-row justify-around items-center pt-32 lg:pt-0 py-10 lg:py-0 relative overflow-hidden">
